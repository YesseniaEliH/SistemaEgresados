...
<body>
	<div class="row fondo">
		<div class="col-sm-10 col-md-10 col-lg-10">
			<h1 class="text-center text-uppercase">Gestion Oferta Laboral</h1>
		</div>
		<div class="col-sm-2 col-md-2 col-lg-2 verticalYess">
			<a href="oferta-nueva.php" class="btn btn-primary active" role="button">Nueva Oferta</a>
		</div>
	</div>
	...
	<div class="row">
		<div id="cuadro1" class="col-sm-12 col-md-12 col-lg-12">
			...
			<div class="table-responsive col-sm-12">
				<table id="t_oferta" class="table table-bordered table-hover" cellspacing="0" width="100%">
					<thead>
						<tr>
							<th>Cargo</th>
							<th>Empresa</th>
	...
	<script>
		...
		var listar = function(){
			...
			obtener_data_editar("#t_oferta tbody", table);
			obtener_id_eliminar("#t_oferta tbody", table);
		}
		...
		var obtener_data_editar = function(tbody, table){
			$(tbody).on("click", "button.editar", function(){
				...
				var id = $("#id").val( data.id_bolsa ),
            vacantes = $("#vacantes").val( data.vacantes ),
						cargo = $("#cargo").val( data.cargo ),
						empresa = $("#empresa select").val( data.id_empresa ),
